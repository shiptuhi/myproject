                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg" id="project_id" v-model="work_does.project_id" @change="getModuleList_2">
                                                <option value="">--Chọn--</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg" v-model="work_does.module_id" @change="getWorkItemList_2">
                                                <option value="">--Chọn--</option>
